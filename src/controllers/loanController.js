...
exports.createLoan = async (req, res) => {
  try {
    console.log("BODY:", req.body);   // debug (can remove later)
    console.log("FILES:", req.files); // debug (can remove later)
    ...
    const {
      ...
      loanDate,
      pendingAmountDate,
      totalRecoverableAmount: clientTotalRecover,
    } = req.body;
